...
and build the multi-scale :class:`~aws_rag.models.chunk.ChunkGraph`. It stops
...
def parse_pdf_to_graph(
    ...
    *,
    ...
    if resolved_backend == "docling":
        ...
        from aws_rag.docling_parser import convert_pdf
    ...
    # ── 2b. Textract path (scanned PDFs) ─────────────────────────────────
        ...
        if not allow_ocr and not have_cached_blocks:
            from aws_rag.costs import pdf_page_count
