...
Mirrors :class:`aws_rag.description.describer.FigureDescriber`'s shape
...
from aws_rag.chunking.layout_parser import BoundingBox
...
from aws_rag.figures import FigureRegion, crop_figure
...
def apply_repaired_structure(element: Any, merged_cells: list[dict[str, Any]]) -> None:
    ...
    """
    from aws_rag.docling_parser import _table_cells_to_compact_text
...
class TableRepairer:
    ...
    def crop_table(
        ...
        *,
        ...
        to :func:`~aws_rag.figures.crop_figure`).
        """
