...
metrics credit a hit by page overlap (see :func:`datasheet_rag.eval.metrics.is_hit`),
...
rendered to PNG via :mod:`datasheet_rag.pdf_render`.
"""
...
from datasheet_rag.store.search import hybrid_search
from datasheet_rag.store.sqlite import _row_to_chunk
    ...
    class Handler(http.server.BaseHTTPRequestHandler):
        ...
        def _serve_page(self, rest: str) -> None:
            ...
            try:
                ...
                self.send_error(400)
                return
            from datasheet_rag.pdf_render import render_page_png
